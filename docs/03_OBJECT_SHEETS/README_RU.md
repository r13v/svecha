...
- Группы и увеличенные детали показаны в разных масштабах. Не вычислять размеры по пикселям листа. Тонкая свеча около 25 см × 7 мм, подсвечник около 1 м и проход около 1,2 м остаются исходными параметрами прототипа из [правил ассетов](../04_BLENDER_ENV/ASSET_PIPELINE_RU.md).
