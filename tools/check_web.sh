...
TASK_SERVER_PID=$!
trap 'agent-browser console --json > .tools/checks/web-console.json; agent-browser errors --json > .tools/checks/web-errors.json; agent-browser screenshot .tools/checks/web-browser-final.png; agent-browser close; kill "$TASK_SERVER_PID"' EXIT
agent-browser --headed open http://127.0.0.1:8788
agent-browser set viewport 1280 720
agent-browser wait --fn '!document.getElementById("status")' --timeout 120000
agent-browser screenshot .tools/checks/web-browser-menu.png
...
agent-browser keyup w
agent-browser screenshot .tools/checks/web-browser-interior.png
agent-browser press Escape
agent-browser wait --fn 'document.pointerLockElement === null'
agent-browser screenshot .tools/checks/web-browser-pause.png
agent-browser wait 1500
agent-browser press Enter
agent-browser wait --fn 'document.pointerLockElement !== null'
